...
```
 - mkdir my-folder
 - cd my-folder
 - git clone git@github.com:Osoro254Alex/Budget-App.git
 - cd Budget-App
 - bundle install
 - rails db:create
 - rails db:migrate
...
Feel free to check the [issues page](https://github.com/Osoro254Alex/Budget-App/issues).
<p align="right">(<a href="#readme-top">back to top</a>)</p>
